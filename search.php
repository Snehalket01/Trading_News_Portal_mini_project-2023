...
<body>
    <div class="container">
        ...
        <div class="card" style="width: 100%; height: 350px;">
            <img class="card-img-top" src="images/images.png" alt="Card image" height="350">
            <div class="card-img-overlay">
                <h4 class="card-title">Trading News Channel</h4>
            ...
            <div class="col-md-6">
                <div class="card flex-md-row mb-4 box-shadow h-md-250">
                    ...
                    while ($row = mysqli_fetch_array($query2)) {
                        ...
                        <img class="card-img-right flex d-none d-md-block" src="images/<?php echo $thumbnail; ?>"
                            alt="Card image cap" width="250px">
                        <?php
                    }
                    ?>
                </div>
